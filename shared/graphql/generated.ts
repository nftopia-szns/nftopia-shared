...
export type TokenByIdQuery = { __typename?: 'Query', token?: { __typename?: 'Token', id: string, address: any, tokenId: any, owner: any, createdAt: any, updatedAt: any } | null };

export type TokensOfContractQueryVariables = Exact<{
  contract: Scalars['Bytes'];
}>;


export type TokensOfContractQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', id: string, address: any, tokenId: any, owner: any, createdAt: any, updatedAt: any }> };

export type TokensOfOwnerQueryVariables = Exact<{
  owner: Scalars['Bytes'];
}>;


export type TokensOfOwnerQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', id: string, address: any, tokenId: any, owner: any, createdAt: any, updatedAt: any }> };
...
export type AskResolvers<ContextType = any, ParentType extends ResolversParentTypes['Ask'] = ResolversParentTypes['Ask']> = {
...
export const TokenByIdDocument = gql`
  ...
  token(id: $tokenId) {
    ...
    `;
export const TokensOfContractDocument = gql`
  ...
  tokens(where: {address: $contract}) {
    ...
    `;
export const TokensOfOwnerDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    tokensOfContract(variables: TokensOfContractQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<TokensOfContractQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TokensOfContractQuery>(TokensOfContractDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'tokensOfContract', 'query');
    },
    tokensOfOwner(variables: TokensOfOwnerQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<TokensOfOwnerQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TokensOfOwnerQuery>(TokensOfOwnerDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'tokensOfOwner', 'query');
    }
  };
}
